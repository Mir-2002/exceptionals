...
const debugAuthState = () => {
  try {
    ...
    console.log('Current mock users:', mockUsers ? JSON.parse(mockUsers) : 'None');
...
const Login = () => {
  ...
  const handleGitHubCallback = async (code) => {
    try {
      ...
      if (import.meta.env.DEV) {
        // In development mode, create a mock GitHub user
        const mockUser = {
          id: 'github-user-123',
        ...
        localStorage.setItem('token', 'mock-github-token-' + Math.random().toString(36).substring(2));
