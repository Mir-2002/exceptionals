...
const GenerateDocumentation = () => {
  ...
  useEffect(() => {
    const fetchProject = async () => {
      try {
        ...
        if (projectId === 'test-123') {
          ...
          setProject({
            ...
            files: [
              ...
              { name: 'config.py', size: '0.9 KB' }
            ],
            exclusions: {
              functions: ['__init__', 'test_function'],
              files: ['test_*.py'],
        ...
        // Don't navigate away for testing
        if (projectId !== 'test-123') {
          navigate('/dashboard');
        }
      } finally {
  ...
  // Helper function to get proper format display name
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-6">
                ...
                {generationStep === 3 && "Using HuggingFace CodeT5 to generate documentation"}
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            {['html', 'pdf', 'markdown'].map((format) => (
              ...
              >
                <div className="font-medium">{getFormatDisplayName(format)}</div>
                <div className="text-sm text-gray-500">
                  {format === 'html' && 'Interactive web format'}
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 font-medium">{getFormatDisplayName(selectedFormat)}</span>
              </div>
              <div>
                <span className="text-gray-600">AI Model:</span>
                <span className="ml-2 font-medium">HuggingFace CodeT5</span>
              </div>
            </div>
          </div>
        </div>
