          ...
          <ul className="flex flex-wrap sm:flex-nowrap items-center justify-center sm:justify-between space-x-2 sm:space-x-4 md:space-x-10 font-work-sans text-base md:text-lg">
            ...
            {!currentUser ? (
              <>
                ...
                <li>
                  <Link to="/register" className="px-4 py-2 bg-white text-sky-800 rounded-md hover:bg-gray-100 font-medium transform hover:scale-110 transition duration-300 ease-in-out hover:shadow-lg">Sign Up</Link>
                </li>
              </>
            ) : (
              <li>
                <button 
                  ...
                  className="px-4 py-2 bg-white text-sky-800 rounded-md hover:bg-gray-100 font-medium"
                >
                  Logout
                </button>
              </li>
